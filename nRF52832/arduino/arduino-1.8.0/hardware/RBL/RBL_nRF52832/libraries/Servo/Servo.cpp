...
#define TIMER_BASE_CLOCK   16000000
#define usToTicks(_us)     ((TIMER_BASE_CLOCK/8/1000000) * _us)    // clockCycles per microseconds.Note : the prescale is 2^3=8.
#define ticksToUs(_ticks)  (((unsigned)_ticks*8) / (TIMER_BASE_CLOCK/8/1000000)) // converts from ticks back to microseconds
...
static void InitISR_handler()
{
    ...
    NRF_TIMER1->PRESCALER = 3;  //prescale = 2^3 = 8; frequency = 16MHz / 8 = 2MHz; 0.5us per tick;
    NRF_TIMER1->BITMODE = TIMER_BITMODE_BITMODE_16Bit;
    NRF_TIMER1->TASKS_CLEAR = 1;
    NRF_TIMER1->CC[0] = (uint32_t)(TIMER_BASE_CLOCK/8/1000); // 2000*0.5us = 1ms
    NRF_TIMER1->EVENTS_COMPARE[0] = 0;
...
uint16_t Servo::readMicroseconds(void)
{
    uint16_t pulsewidth;
