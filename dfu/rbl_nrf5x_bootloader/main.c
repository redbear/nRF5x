...
#define BOOTLOADER_BUTTON               4  //BSP_BUTTON_3                                            /**< Button used to enter SW update mode. */
#define UPDATE_IN_PROGRESS_LED          8 //BSP_LED_2                                               /**< Led used to indicate that DFU is active. */
#define DFU_BLINKY_BLEND2_LED           25                  
#define DFU_BLINKY_NANO2_LED            11
...
{
    nrf_gpio_pin_toggle(DFU_BLINKY_BLEND2_LED);
    nrf_gpio_pin_toggle(DFU_BLINKY_NANO2_LED);
}
...
static void timers_stop(void)
{
    ...
    nrf_gpio_pins_clear(DFU_BLINKY_BLEND2_LED);
    nrf_gpio_pins_clear(DFU_BLINKY_NANO2_LED);
}
